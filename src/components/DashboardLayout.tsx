...
// import PremiumBanner from "@/components/PremiumBanner"; // hidden until billing is live
...
const toolsNav = [
  ...
  // { title: "Billing", url: "/dashboard/billing", icon: CreditCard, badgeKey: null }, // hidden until billing is live
