...
const ChatSchema = z.object({
  ...
  context: z.enum(["rushee", "chapter"]).optional(),
}).passthrough();
...
- Understanding the rush/bid process
- Building genuine connections during recruitment
- Managing stress and expectations during rush
...
- Analyzing which rushees are the best cultural fit for the chapter
- Rush event planning and logistics
- Best practices for fair and inclusive recruitment

Be professional but friendly. Give data-driven, specific advice. Format responses with markdown when helpful.`,
    };

    const systemPrompt = systemPrompts[context] || systemPrompts.rushee;
